...
<div class="container">
    <Navigation last={["/info/quickstart#global", "Quickstart"]}>
        <div id="main">
            ...
            <p>
                Global chat is a system that connects channels across the TCN and allow users to
                chat with each other through it. There are three network-wide channels:
            </p>
            <ul>
                <li>
                    <b>TCN</b> - Public "general" channel which can be made accessible to all server
                    members.
                </li>
                <li>
                    <b>lounge</b> - Staff general chat which can be made accessible to anyone who can
                    access your server's staff chat.
                </li>
                <li>
            ...
            <p>
                You need to ensure the bot has all of the following permissions in all global
            ...
            <ul>
                ...
                <li>
                    <b>Manage Webhooks:</b> to be able to create a webhook / find your webhook for incoming
                    messages
                </li>
                <li>
            ...
            <p>
                Because of the possibility of spam or abusive content, if you do not allow the bot
                to delete messages, it will stop sending them as well.
            </p>
            <Callout style="warn">
                <p>
                    Emoji from non-TCN servers will not work by default due to changes in Discord's
                    bot webhook permissions. To fix this, just create a webhook manually in the
                    channel. You do not need to do anything else.
                </p>
            </Callout>
            <Linkable id="connecting" e="h3" value="Connecting" />
            <Callout style="info">
                <p>
                    Your global channels cannot be used for anything else. All messages sent to the
                    channel are relayed.
                </p>
            </Callout>
            <p>
            ...
            <Callout style="info">
                ...
                <p>
                    Then, send a message from the other side and check that it appears in your
                    channel. If not, <b>Manage Webhooks</b> is missing.
                </p>
                <p>
                    Finally, delete the message from the other side and check that it disappears on
                    your side. If not, <b>Manage Messages</b> is missing.
                </p>
                <p>
                    For staff channels, if you are not staff elsewhere, you may use the global
                    channels in the TCN Hub to test.
                </p>
            </Callout>
            ...
            <p>
                When a message or any copy of it is deleted, all copies of it and the original are
                deleted. If this isn't working, make sure the bot has <b>View Channel</b>,
            ...
            <p>
                ...
                should not be using this in the staff channels unless a staff member is causing
                serious disruption that must be immediately stopped; instead, reach out to the
            ...
            <Callout style="red">
                <p>
                    This command alerts all observers and can only be undone by an observer. Misuse
                    of this command may result in loss of global chat privileges or other
                    consequences. If you think it might be needed, don't be afraid to use it; we
                    will discuss it with you if we think it was unnecessary, but don't play with it
                    or use it for "testing" purposes.
                </p>
            </Callout>
            <p>
                If there is a raid or network-wide incident going on in global chat, you can use <b
                    >/panic</b
                > to completely shut down the global channel. It will cease to relay messages from any
                server.
            </p>

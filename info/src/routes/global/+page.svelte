...
<div class="container">
    <Navigation last={["/quickstart#global", "Quickstart"]}>
        <div id="main">
            <h1>Global Chat</h1>
            <Linkable e="h2" id="what-is-global" value="What is it?" />
            <p>
            ...
            <Linkable e="h3" id="adding-the-bot" value="Adding the bot" />
            <p>
            ...
            <Linkable e="h3" id="permissions" value="Permissions" />
            <p>
            ...
            <Linkable e="h3" id="connecting" value="Connecting" />
            <Callout style="info">
                <p>

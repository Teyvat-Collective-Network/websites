    ...
    <Navigation last={["/info/discord#permissions", "Discord Help"]}>
        <div id="main">
            ...
            <ul>
                <li>
                    If the user is the owner or has a role with the <a
                        href="/info/discord/permission-list#ADMINISTRATOR">Administrator</a
                    > permission, they are allowed.
                </li>
                <li>
                    If the user is timed out or has not passed membership screening and the
                    permission is not <a href="/info/discord/permission-list#VIEW_CHANNEL"
                        >View Channel</a
                    >
                    or
            ...
            <Callout style="info">
                <p>
                    Some permissions are dependent on other permissions. For example, <a
                        href="/info/discord/permission-list#SEND_MESSAGES">Send Messages</a
            ...
            <p>
                ...
                <a href="/info/discord/permission-list#VIEW_CHANNEL">View Channel</a> at a base
                level. All channels are now automatically visible only to verified users. Then, just
                allow
                <code>@everyone</code>

...
<div class="container">
    <Navigation last={["/discord#permissions", "Discord Help"]}>
        <div id="main">
            <h1>Permissions</h1>
            <Linkable e="h2" id="introduction" value="Introduction" />
            <p>
            ...
            <Linkable e="h2" id="mechanics" value="Mechanics" />
            <p>
            ...
            <ul>
                <li>
                    If the user is the owner or has a role with the <a
                        href="/discord/permission-list#ADMINISTRATOR">Administrator</a
                    > permission, they are allowed.
                </li>
                <li>
                    If the user is timed out or has not passed membership screening and the
                    permission is not <a href="/discord/permission-list#VIEW_CHANNEL"
                        >View Channel</a
                    >
                    or
                    <a href="/discord/permission-list#READ_MESSAGE_HISTORY">Read Message History</a
                    >, they are denied.
                </li>
                ...
                <li>
                    If there is an <code>@everyone</code>-level override, it applies.<sup
                        >&dagger;</sup
                    >
                </li>
                <li>
                    If the user has a role that has that permission globally (including <code
                        >@everyone</code
                    >), they are allowed.
                </li>
            ...
            <p>
                ...
                <a href="/discord/permission-list#BAN_MEMBERS">Ban Members</a>, this does not apply.
            </p>
            <Callout style="red">
                <p>
            ...
            <Callout style="info">
                <p>
                    Some permissions are dependent on other permissions. For example, <a
                        href="/discord/permission-list#SEND_MESSAGES">Send Messages</a
                    > only matters if the user can see the channel; if they can't, they can't send messages,
                    even through manual API calls.
                </p>
            </Callout>
            <Linkable e="h2" id="how-to" value="How To" />
            <Linkable e="h3" id="introduction" value="Introduction" />
            <p>
            ...
            <Linkable e="h3" id="verification-role" value="How do I set up a verification role?" />
            <p>
                ...
                you from denying them on other roles. For example, giving it <a
                    href="/discord/permission-list#SEND_MESSAGES">Send Messages</a
                > via an override will stop mute roles from working.
            </p>
            <p>
            ...
            <p>
                If you've decided to do this anyway, the best way to set it up is to deny <code
                    >@everyone</code
                >
                and grant your verification role
                <a href="/discord/permission-list#VIEW_CHANNEL">View Channel</a> at a base level.
                All channels are now automatically visible only to verified users. Then, just allow
                <code>@everyone</code>
                permission to see your landing channels via overrides (remember that allow
                <code>@everyone</code>-level overrides are not an issue).
            </p>
            ...
            <p>
                ...
                <a href="/discord/permission-list#SEND_MESSAGES">Send Messages</a>
            ...
            <Linkable e="h3" id="access-roles" value="How do I set up access roles" />
            <p>
            ...
            <p>
                ...
                <a href="/discord/permission-list#VIEW_CHANNEL">View Channel</a>. Then, add allow
                role-level overrides for any roles you want to grant access.
            </p>
            <p>
            ...
            <Linkable e="h3" id="mute-role" value="How do I set up a mute role?" />
            <p>

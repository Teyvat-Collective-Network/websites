    ...
    <Navigation last={["/other-bots#ruin-hunter", "Other Bots"]}>
        <div id="main">
            ...
            <Callout style="info">
                ...
                <p>
                    <a
                        href="https://discord.com/api/oauth2/authorize?client_id=994100815402909817&permissions=274877959172&scope=bot"
                        >Add To Server</a
                    >
                </p>
            </Callout>
            ...
            <Callout style="green">
                <p>
                    The massban feature on <a href="/other-bots/daedalus">Daedalus</a> is much more comprehensive,
                    and that bot supports better permission controls and more features.
                </p>
            </Callout>
            <p>
            ...
            <ul>
                ...
                <li>
                    <code>bh!allow &lt;role&gt;</code> - allow members with this role to use

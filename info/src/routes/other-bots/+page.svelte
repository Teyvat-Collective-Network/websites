...
<div class="container">
    <Navigation last={["/quickstart#other-bots", "Quickstart"]}>
        <div id="main">
            <h1>Other Bots</h1>
            <Callout style="green">
            ...
            <h5 style="color: var(--accent-lighter)">[Official Partner]</h5>
            <p>
                <a
                    href="https://discord.com/api/oauth2/authorize?client_id=782099719718699009&permissions=537136128&scope=applications.commands%20bot"
                    >Add To Server</a
                >
            </p>
            <p>
                ...
                To get more information or for setup, please contact the support team on their
            ...
            <Linkable e="h2" id="ruin-hunter" value="Ruin Hunter" />
            <p>
            ...
            <p><a href="/other-bots/ruin-hunter">See More</a></p>
            <Linkable e="h2" id="banhammer" value="Banhammer" />
            <p>
            ...
            <p><a href="/other-bots/banhammer">See More</a></p>
            <Callout style="green">
                <p>
            ...
            <Linkable e="h2" id="daedalus" value="Daedalus" />
            <p>
            ...
            <p><a href="/other-bots/daedalus">See More</a></p>
        </div>
    </Navigation>
</div>
